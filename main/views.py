...
from models import Team, Category, Product


@main.route('/team_form', methods=['GET', 'POST'])
...
@main.route('/team_form', methods=['POST'])
...
@main.route("/add_items", methods=['POST', 'GET'])
def add_items():
    if request.method == "POST":
...
@main.route('/cart/<int:product_id>')
